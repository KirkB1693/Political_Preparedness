...
interface CivicsApiService {
    /**
     * Returns a Coroutine [List] of [Election] which can be fetched with await() if in a Coroutine scope.
     * The @GET annotation indicates that the "elections" endpoint will be requested with the GET
     * HTTP method
     */
    @GET("elections")
